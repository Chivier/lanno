...
func NewModel() Model {
	...
	columns := []table.Column{
		table.NewColumn(columnKeyTitle, "Title", width/4).WithFiltered(true),
		table.NewColumn(columnKeyAuthor, "Author", width/4).WithFiltered(true),
		table.NewColumn(columnKeyDescription, "Description", width-width/4-width/4-6).WithFiltered(true),
	}
